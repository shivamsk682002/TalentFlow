        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex justify-end gap-3 mt-4">
            <button
              ...
              className="px-5 py-2 rounded-lg border border-blue-500/30 text-blue-950 hover:bg-blue-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-5 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-700"
